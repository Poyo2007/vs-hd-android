...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch(SONG.song.toLowerCase())
		{
          ...
          var itzday:FlxSprite = new FlxSprite(-170, -70).loadGraphic(Paths.image('day'));
          itzday.scrollFactor.set(0.9, 0.9);
          if (curSong.toLowerCase == 'pickaxe')
          {
            add(itzday);
          }
          
          var itznight:FlxSprite = new FlxSprite(-170, -70).loadGraphic(Paths.image('smphdback'));
          itznight.scrollFactor.set(0.9, 0.9);
          if (curSong.toLowerCase == 'ares')
          {
            add(itznight);
          }
          
          var front:FlxSprite = new FlxSprite(-170, -70).loadGraphic(Paths.image('smphdfront'));
